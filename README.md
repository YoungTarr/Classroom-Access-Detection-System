...
| 2 | ตรวจจับใบหน้าจากเว็บแคมผ่าน WebSocket | ⬜ |
| 3 | กรอบขยับตามลื่น + tracking ข้ามเฟรม | ⬜ |
| 4 | จดจำว่าเป็นใคร (FAISS + ชื่อจากฐานข้อมูล) | ⬜ |
| 5 | ทิศทางการเคลื่อนที่ (ซ้าย / ขวา / อยู่กับที่) | ⬜ |
